...
class AdjacencyListGraph<E extends Comparable<E>> {
	...
	private class Vertex {
		...
		public boolean addAdjacentVertex(final Vertex to) {
			for (final Vertex v : adjacentVerticies)
	 ...
	 *
	 * @param from
	 *            the data of the vertex the edge is from
	 * @param to
	 *            the data of the vertex the edge is going to
	...
	public String toString() {
		...
		for (final Vertex v : verticies) {
			...
			for (final Vertex v2 : v.adjacentVerticies) {
				sb.append(v2.data);
				sb.append(" ");
			}
			sb.append("\n");
