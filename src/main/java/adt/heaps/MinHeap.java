...
public class MinHeap implements Heap {
	...
	public MinHeap(final List<HeapElement> listElements) throws Exception {
	...
	private void swap(final int index1, final int index2) {
		final HeapElement temporaryElement = minHeap.get(index1 - 1);
	...
	private void toggleUp(int elementIndex) {
		final double key = minHeap.get(elementIndex - 1).getKey();
	...
	private HeapElement extractMin() {
		final HeapElement result = minHeap.get(0);
		deleteElement(0);
		return result;
	}
	...
	public void deleteElement(final int elementIndex) {
		...
		// ... or down ?
		else if ((((2 * elementIndex) <= minHeap.size()) && (getElementKey(
