...
/**
 * The Node class which initializes a Node of a tree printLevelOrder: ROOT ->
 * ROOT's CHILDREN -> ROOT's CHILDREN's CHILDREN -> etc findHeight: Returns the
 * height of the tree i.e. the number of links between root and farthest leaf
 */
class Node {
	Node left, right;
	int data;
