...
class Tree<T extends Comparable<T>> {
	...
	public boolean remove(final int value) {
		...
		// Two children
			...
			final Node successor = findSuccessor(temp);
	 ...
	 *
	 * @param n
	 *            Node that you want to find the Successor of
	 * @return The Successor of the node
	 */
	public Node findSuccessor(final Node n) {
		if (n.right == null)
			return n;
	 ...
	 *
	 * @param localRoot
	 *            The local root of the binary tree
	 */
	public void inOrder(final Node localRoot) {
		if (localRoot != null) {
	 ...
	 *            The local root of the binary tree
	 */
	public void preOrder(final Node localRoot) {
		if (localRoot != null) {
			System.out.print(localRoot.data + " ");
	 ...
	 *            The local root of the binary tree
	 */
	public void postOrder(final Node localRoot) {
		if (localRoot != null) {
