...
public class AnyBaseToAnyBase {
	...
	public static void main(String[] args) {
		...
		while (true) {
			try {
				...
				n = in.next();
				System.out.print("Enter beginning base (between " + MINIMUM_BASE
						+ " and " + MAXIMUM_BASE + "): ");
				b1 = in.nextInt();
				...
				System.out.print("Enter end base (between " + MINIMUM_BASE
						+ " and " + MAXIMUM_BASE + "): ");
				b2 = in.nextInt();
	...
	public static boolean validForBase(String n, int base) {
		...
		// Check that every digit in n is within the list of valid digits for
		// that base.
