...
public class DecimalToAnyBase {
	public static void main(String[] args) throws Exception {
		...
		System.out.println("Value of " + decInput + " in base " + base + " is: "
	 ...
	 * 
	 * @param inp
	 *            Decimal of which we need the value in base in String format
	 ...
	 * 
	 * @param num
	 *            integer of which we need the character value of
