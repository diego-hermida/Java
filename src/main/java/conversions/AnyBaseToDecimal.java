...
public class AnyBaseToDecimal {
	public static void main(String[] args) throws Exception {
		...
		System.out.println("Decimal value of " + inp + " is: "
				+ convertToDecimal(inp, base));

		br.close();
	}

	/**
	 * This method produces a decimal value of any given input number of any
	 * base
	 * 
	 * @param inp_num
	 *            String of which we need the decimal value and base in integer
	 *            format
	 ...
	 * 
	 * @param c
	 *            Char of which we need the integer value of
