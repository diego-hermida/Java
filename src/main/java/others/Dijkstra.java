...
public class Solution {
	...
	public static void main(String[] args) throws IOException {
		...
		// Initializing Matrix with Certain Maximum Value for path b/w any two
		// vertices
		for (long[] row : w)
			Arrays.fill(row, 1000000l);
		// From above,we Have assumed that,initially path b/w any two Pair of
		// vertices is Infinite such that Infinite = 1000000l
		// For simplicity , We can also take path Value = Long.MAX_VALUE , but i
		// have taken Max Value = 1000000l .
