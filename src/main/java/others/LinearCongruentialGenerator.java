 ...
 * 
 * @author Tobias Carryer Date: October 10, 2017
 */
public class LinearCongruentialGenerator {
	 ...
	 * @param increment
	 * @param modulo
	 *            The maximum number that can be generated (exclusive). A common
	 *            value is 2^32.
	 */
	public LinearCongruentialGenerator(double multiplier, double increment,
			double modulo) {
	 ...
	 *            value is 2^32.
	 */
	public LinearCongruentialGenerator(double seed, double multiplier,
			double increment, double modulo) {
	...
	public static void main(String[] args) {
		...
		LinearCongruentialGenerator lcg = new LinearCongruentialGenerator(
				1664525, 1013904223, Math.pow(2.0, 32.0));
		for (int i = 0; i < 512; i++) {
